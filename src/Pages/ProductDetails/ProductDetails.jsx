        ...
        <div className='w-full lg:w-2/3 lg:ps-16'>
         ...
         <h1 className='text-4xl font-bold text-gray-900'>{details.title}</h1>
          ...
          <div className='flex my-5 border-b-2 pb-7'>
            <button className='w-[90%] bg-gradient-to-r from-green-300 to-green-500 text-white hover:bg-gradient-to-r hover:from-green-500 hover:to-green-300 rounded-full font-bold transition-all duration-700 py-3 '><IoCartOutline className='inline-block me-2 text-2xl' />Add to cart</button>
